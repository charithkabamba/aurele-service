...
SECRET_KEY = 'django-insecure-vv$9ba@*$#sbf4up9ggm!e4dr8@h(2w%un^m1nimbi=ex^26mn'
...
#     }
# }
# Configuration de la base de données PostgreSQL .env database_url
# DATABASES = {
...
DATABASES = {
    'default': dj_database_url.config(
        default=os.getenv('DATABASE_URL'),  # Use the environment variable
        conn_max_age=600
    )
}
