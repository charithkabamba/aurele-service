...
urlpatterns = i18n_patterns( 
    ...
    path('blog/', include('blog.urls')),  # Existing path
    path('projects/', include('activite.urls')),  # New path for activite
    path('profession/', include('profession.urls')),
    path('i18n/', include('django.conf.urls.i18n')),  # for language switching
    path('rosetta/', include('rosetta.urls')),  # for translation interface
