...
SECRET_KEY = env('SECRET_KEY', default='django-insecure-#e^al=!jmx1ezys5zz=v-iy$t7fl=zton576fheo&w2b1l=ghh')
# SECRET_KEY
...
ALLOWED_HOSTS = ['principal.up.railway.app','.railway.app','aurele-service-production.up.railway.app', '*']
...
# SECURE_SSL_REDIRECT = True  # Render gère SSL automatiquement
